...
- Latest implementation commit: `cce0cb3 feat: support valued executable attributes`
...
- `298dc66`, `1ad8bf2`, `7e769ad`, `d1a3a64`, `b0c39fa`, `9279ac5`, `1694046`, `cce0cb3`: `.gitattributes` SVN property dcommit behavior
...
- Added SVN domain types, mock backend, RA session/fetch editor traits, auth prompt mock, `svn-libsvn` feature shell, fast-import writer, and `git-svn-rs init`.
...
- Direct `.gitattributes` SVN property mapping now includes valued and boolean `svn:executable`, boolean `svn:special`, valued and boolean `svn:needs-lock`, plus later-rule clearing for direct SVN attributes in local `file://` dcommit write-back.
