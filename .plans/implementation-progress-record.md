...
- Latest implementation commit: `1694046 feat: support boolean special attributes`
...
- `298dc66`, `1ad8bf2`, `7e769ad`, `d1a3a64`, `b0c39fa`, `9279ac5`, `1694046`: `.gitattributes` SVN property dcommit behavior
...
- Direct `.gitattributes` SVN property mapping now includes boolean `svn:executable`, boolean `svn:special`, valued and boolean `svn:needs-lock`, plus later-rule clearing for direct SVN attributes in local `file://` dcommit write-back.
